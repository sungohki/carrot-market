  ...
  return (
    ...
    <div className="bg-slate-400 py-20 px-10 grid gap-10 min-h-screen">
      <div className="bg-white p-6 rounded-2xl shadow-2xl text-center">
        ...
        <button
          className="mt-5 w-1/2 mx-auto bg-blue-500 text-white p-3 text-center rounded-2xl hover:bg-teal-500 hover:text-black
      ...
      <div className="bg-white p-10 rounded-2xl shadow-2xl">
        <div className="flex mb-5 justify-between items-center">
          ...
          <div className="space-x-3">
            <span>⭐4.9</span>
            <span className="shadow-3xl p-2 rounded-md">❤</span>
          </div>
        </div>
        ...
        <div className="flex flex-col">
          ...
          <div className="flex justify-between items-center">
            ...
            <button className="bg-blue-500 p-2 px-8 text-xs text-center text-white rounded-lg">
              Add to cart
            </button>
          </div>
        </div>
